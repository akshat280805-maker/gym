        ...
        <section className="px-6 pb-20">
          <div className="max-w-7xl mx-auto">
            <Reveal>
              ...
              >
                <div className="lg:col-span-7 relative aspect-[16/10] overflow-hidden rounded-[2rem] border border-line">
                  <Image
                    src={UNSPLASH(feature.frontmatter.cover ?? DEFAULT_COVER, 1600)}
                ...
                <Reveal key={post.slug} delay={i * 0.06}>
                  <Link href={`/blog/${post.slug}`} className="group block">
                    <div className="relative aspect-[4/3] overflow-hidden rounded-[1.5rem] border border-line">
                      <Image
                        src={UNSPLASH(post.frontmatter.cover ?? DEFAULT_COVER, 1000)}
